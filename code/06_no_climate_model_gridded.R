...
all_data_obs <- NewDataObs %>%
  ...
  select(COMID, PresAbs,-c(ppt_ann:tminMonX12), MRVBF.Mx:AvgSlope, TC_092014_RB9.1_Med:TC_042014_RB9.3_Var, DS_Mag_50:Wet_BFL_Mag_50) %>%
  drop_na()
...
xdata <- all_data_obs[,c(3:35)] ## do not include template layer
...
file.name1 <- "/Users/katieirving/Documents/Documents - Katie’s MacBook Pro/git/Arroyo_toad_RB9/Figures/01_no_clim_model_mds_scale_gridded.jpg"
...
pdf("/Users/katieirving/Documents/Documents - Katie’s MacBook Pro/git/Arroyo_toad_RB9_V2/Figures/01_Trees_no_clim_gridded.pdf", width=25, height=15)
...
pdf("/Users/katieirving/Documents/Documents - Katie’s MacBook Pro/git/Arroyo_toad_RB9_V2/Figures/var_imp_no_clim_gridded.pdf", width=20, height=10)
...
sp=0.6
pdf("/Users/katieirving/Documents/Documents - Katie’s MacBook Pro/git/Arroyo_toad_RB9_V2/Figures/PartialPlots_6_no_clim_gridded.pdf", width=8, height=8)
p <- as.matrix(rf.final$importance)    
ord <- rev(order(p[,1], decreasing=TRUE)[1:dim(p)[1]])  
dotchart(p[ord,1], main="Scaled Variable Importance", pch=19)
plot(rf.final, main="Bootstrap Error Convergence")
