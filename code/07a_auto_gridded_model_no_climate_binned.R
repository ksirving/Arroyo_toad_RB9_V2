...
for(m in models) {
  ...
  gridFile <- paste0("ignore/ModelResults/Binned/", models[m],"/")
  ...
  save(sdata1, file=paste0(gridFile, "all_presAbs_binned.RData"))
  ...
  save(NewDataObsSub, file=paste0(gridFile, "all_presAbs_env_data_binned.RData"))
  ...
  save(rf.data, file=paste0(gridFile, "data_for_rf_model_binned.RData"))
  ...
  save(rf.final, file=paste0(gridFile, "rf_model_binned.RData"))
  ...
  file.name1 <- paste0(gridFile, "no_clim_model_mds_scale_gridded_binned.jpg") 
  ...
  pdf(paste0(gridFile, "Trees_no_clim_gridded_binned.pdf"), width=25, height=15)
  ...
  pdf(paste0(gridFile, "var_imp_no_clim_gridded_binned.pdf"), width=25, height=15)
