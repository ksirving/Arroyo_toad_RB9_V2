...
### everything below moved to model script!!!!
...
a=KDEpts[sample(seq(1:nrow(KDEpts)), size=782, replace=T, prob=KDEpts[,"layer"]),1:2]
...
# 
# ## read in stack created in 00
# xvars <- stack("ignore/00_raw_new_data_raster.tif") ## new rasters @ 200m 
# crs(xvars)
